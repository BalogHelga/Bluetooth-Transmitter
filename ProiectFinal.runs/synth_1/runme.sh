...
HD_PWD='C:/Users/Helga/Desktop/Anul 3/SSC_Proiect/ProiectFinal/ProiectFinal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mmodul_principal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mmodul_principal.tcl
