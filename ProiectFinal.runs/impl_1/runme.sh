...
HD_PWD='C:/Users/Helga/Desktop/Anul 3/SSC_Proiect/ProiectFinal/ProiectFinal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mmodul_principal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mmodul_principal.tcl -notrace
